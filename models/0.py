...
settings.author = "Charlie Romer"
settings.author_email = "cromer@mtholyoke.edu"
settings.keywords = ""
settings.description = ""
settings.layout_theme = "Default"
settings.email_server = "smtp.gmail.com:587"
settings.email_sender = "rune@cs.mtholyoke.edu"
settings.email_login = "rune@cs.mtholyoke.edu:RUNESTONE_GMAIL_MHC_PASS"
